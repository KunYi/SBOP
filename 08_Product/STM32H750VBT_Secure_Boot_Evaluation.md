...
| G2 | **No hardware Ed25519 accelerator.** Software Ed25519 at 400 MHz is fast (~1.2 ms verify) but side-channel resistance depends on implementation quality. | Low | Use fiat-curve25519 + tinycrypt-sha512 (formally verified, constant-time). | SL2 acceptable |
